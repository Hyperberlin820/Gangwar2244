...
bot = telebot.TeleBot('7414987025:AAGy5ahEraCDBMO4cCwk1oEdg86I54YfQn4')
...
✅ Usage: /remove <userid>'''
        ...
        response = "Purchase karle bsdk:- @psycho2465 🔥."
...
def clear_logs_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "Pelhe purchase kar :- @psycho2465 ✅."
    bot.reply_to(message, response)
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "Bc purchase kar na pelhe:- @psycho2465 📌."
    bot.reply_to(message, response)
...
def show_all_users(message):
    ...
    if user_id in admin_id:
        ...
        response = "Pelhe purchase kar uske bad aana :- @psycho2465 ☠️."
    bot.reply_to(message, response)
...
def show_recent_logs(message):
    ...
    if user_id in admin_id:
        ...
        response = "Pelhe purchase kar uske bad aana :- @psycho2465 ."
        bot.reply_to(message, response)
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: Aise hi ma behen karo bgmi ki @psycho2465"
    bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! Pelhe buy to karlo . DM TO BUY ACCESS:- @psycho2465 ")
...
def welcome_start(message):
    ...
    response = f'''☠️Psycho ke world me aapka swagat hai, {user_name}! Sabse acche se bgmi ki ma behen yahi hack karta hai. Kharidne ke liye psycho se sampark karein.
...
3. MAKE SURE YOU JOINED https://t.me/+dqSe3QuF8BU2OTc9 OTHERWISE NOT WORK
